<?php
	...
	if(isset($_POST['edit'])){
		...
		try{
			$stmt = $conn->prepare("UPDATE admins SET email=:email, password=:password, firstname=:firstname, lastname=:lastname, address=:address, contact_info=:contact WHERE id=:id");

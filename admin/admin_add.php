<?php
	...
	if(isset($_POST['add'])){
		...
		if($row['numrows'] > 0){
			...
			try{
				$stmt = $conn->prepare("INSERT INTO admins (email, type, password, firstname, lastname, address, contact_info, photo, status, created_on) VALUES (:email,1, :password, :firstname, :lastname, :address, :contact, :photo, :status, :created_on)");
